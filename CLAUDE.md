...
- **Conservative defaults are not negotiable in-conversation.** If a threshold says ≤6 ft swell, the verdict is NO-GO at 6.1 ft. The user wrote the thresholds to bind future-self. Don't soften them at runtime.
