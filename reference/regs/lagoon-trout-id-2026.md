...
**Confidence:** UNVERIFIED — adipose-clip identification and wild-vs-hatchery retention rules not confirmed from CDFW pages during 2026-06-15 sourcing session. Do not rely on retention rules here without checking CDFW steelhead regulations directly.
...
- [ ] Basibranchial teeth mark for cutthroat not found on CDFW Coastal Cutthroat Trout page — verify or remove
- [ ] Worn/rounded fins for hatchery rainbow not confirmed by CDFW — verify or remove
- [ ] Confirm current steelhead wild-vs-hatchery retention rules for these waters (adipose-clip rule not confirmed from CDFW inland pages)
